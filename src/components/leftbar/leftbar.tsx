...
const LeftBar = () => {
    ...
    return (
        <div className="h-screen bg-black md:w-1/4 lg:w-1/5 xl:w-1/6 p-4 shadow-md border-r-2 hidden md:block">
            <div className="flex flex-col items-center h-full justify-between">
                ...
                <ul className="flex flex-col gap-6 text-white text-sm">
                    ...
                    <li className={`${pathname === "/Dashboard" ? "font-bold" : ""}`}>
                        <Link href="/Dashboard" className="hover:text-white flex flex-row gap-3 items-center">
                            <IoSearch />Search
                        </Link>
                    </li>
